...
using Milibreria;
using JKBeauty;
using JKBeautyEmpleado;

namespace Login_JKBeauty
{
    public partial class Login : Form
    {
        JKBeauty.LogearAdmin logear = new JKBeauty.LogearAdmin();
        JKBeautyEmpleado.LogearEmpleado logearEmpleado = new JKBeautyEmpleado.LogearEmpleado();
        public Login()
        {
            InitializeComponent();
        }
